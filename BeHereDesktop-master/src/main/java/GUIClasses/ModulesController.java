...
public class ModulesController implements Initializable{
    ...
    public void ajouterModule(ActionEvent actionEvent) {
        ...
        module.setVHcours(Float.parseFloat(vhCoursTextField.getText()));
        module.setVHtd(Float.parseFloat(vhTdTextField.getText()));
        module.setVHtp(Float.parseFloat(vhTpTextField.getText()));
